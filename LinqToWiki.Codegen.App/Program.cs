...
namespace LinqToWiki.Codegen.App
{
    static class Program
    {
        ...
        private static void Usage()
        {
            ...
            Console.WriteLine("Usage:    {0} url-to-api [namespace [output-name]] [-d output-directory]", applicationName);
            Console.WriteLine(@"Examples: {0} en.wikipedia.org LinqToWiki.Enwiki linqtowiki-enwiki -d C:\Temp", applicationName);
        ...
        private static void Run(string[] args)
        {
            ...
            var wiki = new Wiki(baseUrl, apiPath, arguments.Namespace);
            wiki.AddAllModules();
