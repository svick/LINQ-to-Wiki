...
%TODO: update
As of 9 May 2012, the patch that adds this ability to the \texttt{paraminfo} module and the necessary
...
<module name="categorymembers" prefix="cm" querytype="list"
  ...
  <parameters>
    ...
    <param name="sort" default="sortkey" description="Property to ...">
